  ...
  extends HorizontalScrollView
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    if (!this.e)
    {
      Object localObject = this.g.getChildAt(0);
      View localView = this.g.getChildAt(1);
      localObject = ((View)localObject).getLayoutParams();
      if ((this.c == 0) && (((ViewGroup.LayoutParams)localObject).width < 0)) {
        ((ViewGroup.LayoutParams)localObject).width = ((int)(this.a * 0.8D));
      }
      this.c = ((ViewGroup.LayoutParams)localObject).width;
      this.d = (((ViewGroup.LayoutParams)localObject).width / 2);
      localView.getLayoutParams().width = this.a;
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\widget\SlidingLayout.class
