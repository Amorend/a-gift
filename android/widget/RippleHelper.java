  ...
  implements View.OnTouchListener
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.b != 0)
    {
      ...
      while (i1 >= 0)
      {
        paramCanvas.drawCircle(this.k, this.l, Math.min(i1, i3), this.j);
        i2 += 1;
        if (i2 >= 2)
        {
          ...
          localPaint.setShader(new RadialGradient(f1, f2, f3, new int[] { 1157627903, i1, 1140850688 }, null, localTileMode));
          this.j.setStyle(Paint.Style.STROKE);
          this.j.setColor(this.q);
          paramCanvas.drawCircle(this.k, this.l, this.g % i3, this.j);
          break;
        }
        i1 -= i3;
      }
    ...
    extends TimerTaskX
  {
    ...
    public void run()
    {
      ...
      case 3: 
        ...
        break;
      case 2: 
        RippleHelper.a(RippleHelper.this, RippleHelper.c(RippleHelper.this) + RippleHelper.d(RippleHelper.this) * 4);
        RippleHelper.b(RippleHelper.this, Math.min(RippleHelper.e(RippleHelper.this), RippleHelper.c(RippleHelper.this) / RippleHelper.d(RippleHelper.this) * 2));
        RippleHelper.f(RippleHelper.this).postInvalidate();
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\widget\RippleHelper.class
