...
public class FloatWindow
{
  ...
  private void a(Context paramContext)
  {
    ...
    Object localObject = paramContext.getTheme().obtainStyledAttributes(new int[] { 16842801, 16842806 });
    int k = ((TypedArray)localObject).getColor(0, 16711935);
    this.g = ((TypedArray)localObject).getColor(1, 16711935);
    ((TypedArray)localObject).recycle();
    localObject = new GradientDrawable();
    ((GradientDrawable)localObject).setColor(k);
    ((GradientDrawable)localObject).setCornerRadius(4.0F);
    ((GradientDrawable)localObject).setStroke(2, this.g);
    ((GradientDrawable)localObject).setAlpha(136);
    ...
    extends LinearLayout
  {
    ...
    {
      super();
      this.b = new FloatWindow.TitleView(FloatWindow.this, paramContext);
      this.b.setSingleLine(true);
      paramContext = new TextView(paramContext);
      paramContext.setText("X");
      ...
      paramContext.setBackgroundDrawable(localGradientDrawable);
      ...
      addView(paramContext, new LinearLayout.LayoutParams(FloatWindow.a(FloatWindow.this, 24.0F), FloatWindow.a(FloatWindow.this, 24.0F)));
    }
    ...
    extends TextView
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      else if (paramMotionEvent.getAction() == 2)
      {
        ...
        FloatWindow.b(FloatWindow.this).y = (this.e + (this.g - this.c) - this.f + 3);
        FloatWindow.d(FloatWindow.this).updateViewLayout(FloatWindow.c(FloatWindow.this), FloatWindow.b(FloatWindow.this));
      }
      return true;
    }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\app\FloatWindow.class
