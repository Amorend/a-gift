...
class PathParser
{
  ...
  public static void updateNodes(PathDataNode[] paramArrayOfPathDataNode1, PathDataNode[] paramArrayOfPathDataNode2)
  {
    ...
    while (i < paramArrayOfPathDataNode2.length)
    {
      ...
      int j = 0;
      while (j < paramArrayOfPathDataNode2[i].params.length)
      {
  ...
  public static class PathDataNode
  {
    ...
    private static void drawArc(Path paramPath, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, boolean paramBoolean1, boolean paramBoolean2)
    {
      ...
      for (d1 = d4 - 6.283185307179586D;; d1 = d4 + 6.283185307179586D)
      {
        d3 *= paramFloat5;
        d2 = paramFloat6 * d2;
        arcToBezier(paramPath, d3 * d6 - d2 * d7, d3 * d7 + d6 * d2, paramFloat5, paramFloat6, paramFloat1, paramFloat2, d5, d8, d1);
        return;
        d3 = d10 + d3;
        d2 -= d11;
        break;
    ...
    {
      int i = 0;
      while (i < paramPathDataNode1.params.length)
      {
        this.params[i] = (paramPathDataNode1.params[i] * (1.0F - paramFloat) + paramPathDataNode2.params[i] * paramFloat);
        i += 1;
      }
    }
  }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\graphics\drawable\PathParser.class
