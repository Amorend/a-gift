...
public class NotificationCompat
{
    ...
    implements NotificationCompat.NotificationCompatImpl
  {
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      paramBuilderExtender = NotificationCompatBase.add(paramBuilder.mNotification, paramBuilder.mContext, paramBuilder.resolveTitle(), paramBuilder.resolveText(), paramBuilder.mContentIntent, paramBuilder.mFullScreenIntent);
    ...
    extends NotificationCompat.NotificationCompatImplBase
  {
    public Notification build(NotificationCompat.Builder paramBuilder, NotificationCompat.BuilderExtender paramBuilderExtender)
    {
      ...
      if (paramBuilder.mStyle != null)
      {
        localObject = getExtras(paramBuilderExtender);
        if (localObject != null) {
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v4\app\NotificationCompat.class
