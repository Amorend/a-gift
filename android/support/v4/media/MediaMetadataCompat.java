      ...
      while (paramMediaMetadataCompat.hasNext())
      {
        ...
        if ((localObject != null) && ((localObject instanceof Bitmap)))
        {
          ...
          if ((((Bitmap)localObject).getHeight() > paramInt) || (((Bitmap)localObject).getWidth() > paramInt)) {
            ...
            putBitmap(str, ((Bitmap)localObject).copy(((Bitmap)localObject).getConfig(), false));
          }
        }
      }
    }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v4\media\MediaMetadataCompat.class
