...
public final class MediaControllerCompat
{
  ...
  public static MediaControllerCompat getMediaController(Activity paramActivity)
  {
    ...
    if ((paramActivity instanceof SupportActivity))
    {
      ...
      {
        paramActivity = paramActivity.getMediaController();
    ...
    implements IBinder.DeathRecipient
  {
      ...
      extends IMediaControllerCallback.Stub
    {
        ...
        throws RemoteException
      {
        ...
        for (paramParcelableVolumeInfo = new MediaControllerCompat.PlaybackInfo(paramParcelableVolumeInfo.volumeType, paramParcelableVolumeInfo.audioStream, paramParcelableVolumeInfo.controlType, paramParcelableVolumeInfo.maxVolume, paramParcelableVolumeInfo.currentVolume);; paramParcelableVolumeInfo = null)
        {
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    private List<MediaControllerCompat.Callback> mPendingCallbacks = new ArrayList();
    ...
    public boolean isShuffleModeEnabled()
    {
      if (this.mExtraBinder != null) {
        try
        {
          boolean bool = this.mExtraBinder.isShuffleModeEnabled();
          return bool;
        }
        catch (RemoteException localRemoteException)
        {
    ...
    public void removeQueueItemAt(int paramInt)
    {
      ...
      Bundle localBundle = new Bundle();
      localBundle.putInt("android.support.v4.media.session.command.ARGUMENT_INDEX", paramInt);
      sendCommand("android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT", localBundle, null);
    }
      ...
      extends ResultReceiver
    {
      ...
      protected void onReceiveResult(int paramInt, Bundle paramBundle)
      {
        ...
        MediaControllerCompat.MediaControllerImplApi21.access$002(localMediaControllerImplApi21, IMediaSession.Stub.asInterface(BundleCompat.getBinder(paramBundle, "android.support.v4.media.session.EXTRA_BINDER")));
      ...
      extends IMediaControllerCallback.Stub
    {
      ...
      public void onShuffleModeChanged(final boolean paramBoolean)
        throws RemoteException
      {
        this.mCallback.mHandler.post(new Runnable()
        {
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    public boolean isShuffleModeEnabled()
    {
      try
      {
        boolean bool = this.mBinder.isShuffleModeEnabled();
        return bool;
      }
      catch (RemoteException localRemoteException)
      {
    ...
    public void removeQueueItemAt(int paramInt)
    {
      ...
      {
        Log.e("MediaControllerCompat", "Dead object in removeQueueItemAt.", localRemoteException);
        return;
      }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
