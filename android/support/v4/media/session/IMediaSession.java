    ...
    implements IMediaSession
  {
      ...
      throws RemoteException
    {
      ...
      case 42: 
        ...
        {
          addQueueItemAt((MediaDescriptionCompat)localObject, paramParcel1.readInt());
          paramParcel2.writeNoException();
          return true;
        }
      case 43: 
      ...
      implements IMediaSession
    {
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 46	android/support/v4/media/MediaDescriptionCompat:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        ...
        throws RemoteException
      {
        ...
        //   25: aload_3
        //   26: iconst_0
        //   27: invokevirtual 46	android/support/v4/media/MediaDescriptionCompat:writeToParcel	(Landroid/os/Parcel;I)V
        //   30: aload_3
        //   31: iload_2
        ...
        throws RemoteException
      {
        ...
        //   37: ifeq +26 -> 63
        //   40: getstatic 81	android/os/Bundle:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 87 2 0
        //   49: checkcast 77	android/os/Bundle
        //   52: astore_1
        //   53: aload_3
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 75	android/os/Parcel:readInt	()I
        //   37: ifeq +26 -> 63
        //   40: getstatic 99	android/app/PendingIntent:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 87 2 0
        //   49: checkcast 98	android/app/PendingIntent
        //   52: astore_1
        //   53: aload_3
        //   54: invokevirtual 58	android/os/Parcel:recycle	()V
        //   57: aload_2
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 75	android/os/Parcel:readInt	()I
        //   37: ifeq +26 -> 63
        //   40: getstatic 104	android/support/v4/media/MediaMetadataCompat:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 87 2 0
        //   49: checkcast 103	android/support/v4/media/MediaMetadataCompat
        //   52: astore_1
        //   53: aload_3
        //   54: invokevirtual 58	android/os/Parcel:recycle	()V
        //   57: aload_2
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 75	android/os/Parcel:readInt	()I
        //   37: ifeq +26 -> 63
        //   40: getstatic 113	android/support/v4/media/session/PlaybackStateCompat:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 87 2 0
        //   49: checkcast 112	android/support/v4/media/session/PlaybackStateCompat
        //   52: astore_1
        //   53: aload_3
        //   54: invokevirtual 58	android/os/Parcel:recycle	()V
        //   57: aload_2
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 75	android/os/Parcel:readInt	()I
        //   37: ifeq +26 -> 63
        //   40: getstatic 131	android/text/TextUtils:CHAR_SEQUENCE_CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 87 2 0
        //   49: checkcast 133	java/lang/CharSequence
        //   52: astore_1
        //   53: aload_3
        //   54: invokevirtual 58	android/os/Parcel:recycle	()V
        //   57: aload_2
        ...
        throws RemoteException
      {
        ...
        //   34: invokevirtual 75	android/os/Parcel:readInt	()I
        //   37: ifeq +26 -> 63
        //   40: getstatic 141	android/support/v4/media/session/ParcelableVolumeInfo:CREATOR	Landroid/os/Parcelable$Creator;
        //   43: aload_3
        //   44: invokeinterface 87 2 0
        //   49: checkcast 140	android/support/v4/media/session/ParcelableVolumeInfo
        //   52: astore_1
        //   53: aload_3
        //   54: invokevirtual 58	android/os/Parcel:recycle	()V
        //   57: aload_2
        ...
        throws RemoteException
      {
        ...
        //   30: aload_3
        //   31: iconst_0
        //   32: invokevirtual 150	android/os/Bundle:writeToParcel	(Landroid/os/Parcel;I)V
        //   35: aload_0
        //   36: getfield 19	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   39: bipush 14
        //   41: aload_3
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 166	android/support/v4/media/RatingCompat:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 19	android/support/v4/media/session/IMediaSession$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   33: bipush 25
        //   35: aload_2
        ...
        throws RemoteException
      {
        ...
        //   25: aload_2
        //   26: aload_1
        //   27: invokevirtual 175	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   30: aload_0
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v4\media\session\IMediaSession.class
