  ...
  implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener
{
  ...
  private void showMenu(@NonNull MenuBuilder paramMenuBuilder)
  {
    ...
    if ((!isShowing()) && (this.mForceShowIcon))
    {
      ...
      localMenuPopupWindow.setVerticalOffset(k + j);
    }
    for (;;)
    {
      ...
      if (i != 0)
      {
        i = ((View)localObject2).getWidth() + n;
        break label234;
      }
      i = n - m;
      break label234;
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\view\menu\CascadingMenuPopup.class
