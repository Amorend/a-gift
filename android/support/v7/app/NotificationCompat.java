  ...
  extends android.support.v4.app.NotificationCompat
{
  ...
  private static CharSequence makeMessageLine(android.support.v4.app.NotificationCompat.Builder paramBuilder, NotificationCompat.MessagingStyle paramMessagingStyle, NotificationCompat.MessagingStyle.Message paramMessage)
  {
    ...
    {
      k = 1;
      if ((k == 0) && (Build.VERSION.SDK_INT > 10)) {
        break label174;
      }
      i = -16777216;
      localCharSequence = paramMessage.getSender();
    ...
    for (int j = paramBuilder.getColor();; j = i)
    {
      paramBuilder = localBidiFormatter.unicodeWrap(paramMessagingStyle);
      localSpannableStringBuilder.append(paramBuilder);
      localSpannableStringBuilder.setSpan(makeFontColorSpan(j), localSpannableStringBuilder.length() - paramBuilder.length(), localSpannableStringBuilder.length(), 33);
      ...
      label195:
      paramMessagingStyle = localCharSequence;
    }
  }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\app\NotificationCompat.class
