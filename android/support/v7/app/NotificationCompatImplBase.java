...
class NotificationCompatImplBase
{
  ...
  public static RemoteViews applyStandardTemplate(Context paramContext, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, int paramInt1, int paramInt2, Bitmap paramBitmap, CharSequence paramCharSequence4, boolean paramBoolean1, long paramLong, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean2)
  {
    ...
    if (paramInt3 < -1)
    {
      ...
      if (paramInt2 != 0)
      {
        ...
        paramInt5 = localResources.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding);
        if (Build.VERSION.SDK_INT < 21) {
          break label509;
        }
        paramContext = createIconWithBackground(paramContext, paramInt2, paramInt3, paramInt3 - paramInt5 * 2, paramInt4);
    ...
    for (paramInt2 = 1;; paramInt2 = 0)
    {
      if ((Build.VERSION.SDK_INT < 21) && (paramBitmap != null))
      {
        ...
        paramInt1 = 1;
        paramInt2 = 1;
        if ((paramCharSequence4 == null) || (Build.VERSION.SDK_INT < 16)) {
          break label720;
        }
    ...
    if (paramArrayList != null)
    {
      ...
      if (paramInt1 > 0) {
        if (paramInt1 > 3)
        {
          ...
          {
            paramCharSequence2 = generateActionButton(paramContext, (NotificationCompat.Action)paramArrayList.get(paramInt2));
  ...
  public static int calculateTopPadding(Context paramContext)
  {
    ...
    return Math.round(i * (1.0F - f) + j * f);
  }
  ...
  private static Bitmap createColoredBitmap(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt3 == 0) {}
    for (paramInt1 = paramContext.getIntrinsicWidth();; paramInt1 = paramInt3)
    {
      int i = paramInt3;
      if (paramInt3 == 0) {
        i = paramContext.getIntrinsicHeight();
      }
      Bitmap localBitmap = Bitmap.createBitmap(paramInt1, i, Bitmap.Config.ARGB_8888);
      paramContext.setBounds(0, 0, paramInt1, i);
      if (paramInt2 != 0) {
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\app\NotificationCompatImplBase.class
