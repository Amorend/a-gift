  ...
  implements DecorContentParent, NestedScrollingParent
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int m = ViewUtils.combineMeasuredStates(0, ViewCompat.getMeasuredState(this.mActionBarTop));
    int k;
    if ((ViewCompat.getWindowSystemUiVisibility(this) & 0x100) != 0)
    {
      j = 1;
    ...
    for (;;)
    {
      ...
      for (((Rect)localObject).bottom += 0;; ((Rect)localObject).bottom += 0)
      {
        ...
        k = ViewUtils.combineMeasuredStates(m, ViewCompat.getMeasuredState(this.mContent));
        m = getPaddingLeft();
        n = getPaddingRight();
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\widget\ActionBarOverlayLayout.class
