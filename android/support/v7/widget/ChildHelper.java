...
class ChildHelper
{
  ...
  static class Bucket
  {
    ...
    void insert(int paramInt, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        if ((this.mData & 0x8000000000000000) != 0L)
        {
          ...
          long l2 = this.mData;
          this.mData = (((l1 ^ 0xFFFFFFFFFFFFFFFF) & this.mData) << 1 | l2 & l1);
          if (!paramBoolean) {
            break label113;
          }
          set(paramInt);
    ...
    boolean remove(int paramInt)
    {
      ...
      {
        this.mData &= (l1 ^ 0xFFFFFFFFFFFFFFFF);
        l1 -= 1L;
        long l2 = this.mData;
        this.mData = (Long.rotateRight((l1 ^ 0xFFFFFFFFFFFFFFFF) & this.mData, 1) | l2 & l1);
        bool2 = bool1;
        if (this.next == null) {
          break;
        }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\widget\ChildHelper.class
