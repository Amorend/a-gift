  ...
  extends ViewGroup
{
  ...
  void measureHorizontal(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (i4 = Math.max(k, Math.max(localObject[3], Math.max(localObject[0], Math.max(localObject[1], localObject[2]))) + Math.max(arrayOfInt[3], Math.max(arrayOfInt[0], Math.max(arrayOfInt[1], arrayOfInt[2]))));; i4 = k)
      {
        ...
        i8 = ViewCompat.resolveSizeAndState(Math.max(this.mTotalLength, getSuggestedMinimumWidth()), paramInt1, 0);
  ...
  void measureVertical(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      i6 = ViewCompat.resolveSizeAndState(Math.max(this.mTotalLength, getSuggestedMinimumHeight()), paramInt2, 0);
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\widget\LinearLayoutCompat.class
