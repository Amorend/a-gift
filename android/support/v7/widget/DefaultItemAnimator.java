  ...
  extends SimpleItemAnimator
{
  ...
  void animateChangeImpl(final ChangeInfo paramChangeInfo)
  {
    ...
    final Object localObject = paramChangeInfo.oldHolder;
    if (localObject == null) {}
    for (localObject = null;; localObject = ((RecyclerView.ViewHolder)localObject).itemView)
    {
      ...
      if (localObject != null)
      {
        ...
        ((ViewPropertyAnimatorCompat)localObject).alpha(0.0F).setListener(new VpaListenerAdapter()
        {
          public void onAnimationEnd(View paramAnonymousView)
          {
      ...
      if (localView != null)
      {
        ...
        ((ViewPropertyAnimatorCompat)localObject).translationX(0.0F).translationY(0.0F).setDuration(getChangeDuration()).alpha(1.0F).setListener(new VpaListenerAdapter()
        {
          public void onAnimationEnd(View paramAnonymousView)
          {
            localObject.setListener(null);
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\widget\DefaultItemAnimator.class
