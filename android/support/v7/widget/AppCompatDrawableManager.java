  ...
  ColorStateList getTintList(@NonNull Context paramContext, @DrawableRes int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == R.drawable.abc_switch_track_mtrl_alpha) {
        ...
        localColorStateList1 = AppCompatResources.getColorStateList(paramContext, R.color.abc_tint_switch_thumb);
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\widget\AppCompatDrawableManager.class
