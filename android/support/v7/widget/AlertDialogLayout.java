  ...
  extends LinearLayoutCompat
{
  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (localObject2 != null)
    {
      ...
      j += i;
      k = ViewCompat.combineMeasuredStates(k, ViewCompat.getMeasuredState((View)localObject2));
      m -= i;
    }
    for (;;)
    {
      ...
      if (localObject4 != null) {
        if (i5 == 0)
        {
          ...
          j += i1;
          k = ViewCompat.combineMeasuredStates(k, ViewCompat.getMeasuredState((View)localObject4));
        }
      }
      for (;;)
      {
        ...
        for (j = k;; j = k)
        {
          if ((localObject4 != null) && (i2 > 0))
          {
            ...
            j = ViewCompat.combineMeasuredStates(j, ViewCompat.getMeasuredState((View)localObject4));
            i = i - i1 + k;
          }
          for (;;)
          {
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\widget\AlertDialogLayout.class
