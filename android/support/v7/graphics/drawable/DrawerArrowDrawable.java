  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    default: 
      if (DrawableCompat.getLayoutDirection(this) == 1)
      {
        ...
        f2 = (float)((int)(localRect.height() - 3.0F * f2 - this.mBarGap * 2.0F) / 4 * 2 + (f2 * 1.5D + this.mBarGap));
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\v7\graphics\drawable\DrawerArrowDrawable.class
