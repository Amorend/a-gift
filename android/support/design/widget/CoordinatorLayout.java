  ...
  implements NestedScrollingParent
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      m = ViewCompat.combineMeasuredStates(i, ViewCompat.getMeasuredState(localView));
      i = k;
      k = m;
      break;
      label492:
      ...
      break label289;
      label536:
      setMeasuredDimension(ViewCompat.resolveSizeAndState(k, paramInt1, 0xFF000000 & i), ViewCompat.resolveSizeAndState(j, paramInt2, i << 16));
      return;
      i4 = paramInt2;
      i3 = paramInt1;
    }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\android\support\design\widget\CoordinatorLayout.class
