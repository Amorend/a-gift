  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void setItems(String[] paramArrayOfString)
  {
    ...
    setAdapter(new ArrayListAdapter(this.a, 17367043, paramArrayOfString));
  ...
  {
    paramArrayOfCharSequence = new ArrayList(Arrays.asList(paramArrayOfCharSequence));
    setAdapter(new ArrayListAdapter(this.a, 17367056, paramArrayOfCharSequence));
    ...
    while (i < j)
    {
      ...
      this.b.setItemChecked(paramArrayOfInt[k], true);
      i += 1;
    }
  }
  ...
  {
    paramArrayOfCharSequence = new ArrayList(Arrays.asList(paramArrayOfCharSequence));
    setAdapter(new ArrayListAdapter(this.a, 17367055, paramArrayOfCharSequence));
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\com\androlua\LuaDialog.class
