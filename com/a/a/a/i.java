  ...
  extends g
{
  ...
  public i(c paramc)
  {
    ...
    this.l = ((int)TypedValue.applyDimension(2, (float)(c.d * 1.5D), paramc));
    this.e = new a();
    this.f = new a();
    this.g = new a();
  }
  ...
  private void a(a parama, MotionEvent paramMotionEvent)
  {
    ...
    {
      this.c.moveCaret(m);
      paramMotionEvent = this.c.c(m);
      parama.a(paramMotionEvent.left + this.c.getPaddingLeft(), paramMotionEvent.bottom + this.c.getPaddingTop());
    }
  }
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    if (!this.c.isSelectText2())
    {
      ...
      if (!this.j)
      {
        localRect = this.c.c(this.c.getCaretPosition());
        m = localRect.left;
    ...
    if ((!this.h) || (!this.i))
    {
      localRect = this.c.c(this.c.getSelectionStart());
      m = localRect.left;
      n = this.c.getPaddingLeft();
      i1 = localRect.bottom;
      i2 = this.c.getPaddingTop();
      this.f.b(m + n, i1 + i2);
      localRect = this.c.c(this.c.getSelectionEnd());
      m = localRect.left;
      n = this.c.getPaddingLeft();
      i1 = localRect.bottom;
      i2 = this.c.getPaddingTop();
  ...
  private class a
  {
    ...
    {
      int m = a();
      paramCanvas.drawLine(this.e, this.f, this.g + m, this.h + m, this.k);
      float f1 = this.e - m;
      int n = this.f;
      int i1 = m / 2;
      paramCanvas.drawArc(new RectF(f1, n - i1 - this.c, this.g + m * 2, this.h + i1), 60.0F, 60.0F, true, this.k);
    ...
    {
      paramInt1 = i.this.a(paramInt1) - this.i + a();
      paramInt2 = i.this.b(paramInt2) - this.j - this.c - 2;
      return new m(i.this.c.a(paramInt1, paramInt2), i.this.c.b(paramInt1, paramInt2));
    }
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\com\a\a\a\i.class
