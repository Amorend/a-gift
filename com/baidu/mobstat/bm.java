...
class bm
{
  ...
  {
    c.post(new bo(this, paramContext, paramString1, paramString2, paramInt, paramLong, paramExtraInfo));
  }
  ...
  {
    c.post(new bq(this, paramString1, paramString2, paramLong, paramContext, paramExtraInfo));
  }
  
  public void b(Context paramContext, String paramString1, String paramString2, long paramLong, ExtraInfo paramExtraInfo)
  {
    c.post(new br(this, paramLong, paramContext, paramString1, paramString2, paramExtraInfo));
  }
}


/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\com\baidu\mobstat\bm.class
