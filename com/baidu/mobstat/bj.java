  ...
  extends bk
{
  ...
  {
    putString(paramContext, "device_id_1", paramString);
  }
  ...
  {
    return getString(paramContext, "device_id_1", null);
  }
  
  protected void d(Context paramContext, String paramString)
  {
    putString(paramContext, "mtjsdkmacss2_1", paramString);
  }
  
  protected void d(Context paramContext, boolean paramBoolean)
  {
    putBoolean(paramContext, "mtjsdkmactrick", paramBoolean);
  }
  
  protected String e(Context paramContext)
  {
    return getString(paramContext, "cuidsec_1", null);
  }
  
  protected void e(Context paramContext, String paramString)
  {
    putString(paramContext, "mtjsdkmacsstv_1", paramString);
  }
  ...
  {
    putString(paramContext, "he.ext", paramString);
  }
  ...
  {
    return getString(paramContext, "mtjsdkmacss2_1", null);
  }
  ...
  {
    return getString(paramContext, "mtjsdkmacsstv_1", null);
  }
  
  protected String k(Context paramContext)
  {
    return getString(paramContext, "he.ext", null);
  }
  
  protected boolean l(Context paramContext)
  {
    return getBoolean(paramContext, "mtjsdkmactrick", true);
  }
}


/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\com\baidu\mobstat\bj.class
