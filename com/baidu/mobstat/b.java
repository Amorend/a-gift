...
public final class b
{
  ...
  public static String a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    for (int k = 0; j < i1; k = m)
    {
      ...
      int n = j + 1;
      arrayOfByte1[m] = arrayOfByte2[((i2 & 0x3) << 4 | (paramArrayOfByte[n] & 0xFF) >> 4)];
      m = i + 1;
      arrayOfByte2 = a;
      n = paramArrayOfByte[n];
      i2 = j + 2;
      arrayOfByte1[i] = arrayOfByte2[((n & 0xF) << 2 | (paramArrayOfByte[i2] & 0xFF) >> 6)];
      n = m + 1;
      arrayOfByte1[m] = a[(paramArrayOfByte[i2] & 0x3F)];
      i = n;
      m = k;
      if ((n - k) % 76 == 0)
      {
    ...
    case 2: 
      j = i + 1;
      arrayOfByte1[i] = a[((paramArrayOfByte[i1] & 0xFF) >> 2)];
      i = j + 1;
      arrayOfByte2 = a;
    ...
    case 1: 
      ...
      arrayOfByte1[i] = a[((paramArrayOfByte[i1] & 0xFF) >> 2)];
      i = j + 1;
      arrayOfByte1[j] = a[((paramArrayOfByte[i1] & 0x3) << 4)];
      j = i + 1;
      arrayOfByte1[i] = 61;
      i = j + 1;
      arrayOfByte1[j] = 61;
...
/* Location:              C:\Users\12724\Desktop\classes-dex2jar.jar!\com\baidu\mobstat\b.class
